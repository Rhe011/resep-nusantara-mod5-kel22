...
import LazyImage from '../common/LazyImage'; // <-- WAJIB
    ...
    <section>
      <div className="flex items-center justify-between mb-6 md:mb-8">
        ...
        <button 
          ...
          className="text-slate-500 hover:text-slate-600 font-medium text-xs md:text-sm transition-colors hover:underline"
        >
          Lihat Semua
        </button>
      </div>
        ...
        {recipes.map((recipe, index) => (
          ...
          >
            <div
              ...
              className="relative bg-white/15 backdrop-blur-xl border border-white/25 rounded-2xl md:rounded-3xl overflow-hidden shadow-lg md:shadow-2xl hover:shadow-indigo-500/15 transition-all cursor-pointer group-hover:scale-105 group-hover:bg-white/20"
            >
              ...
              <div className="flex">
                ...
                <div className="relative z-10 p-4 md:p-8 flex-1 flex flex-col justify-center">
                  <div className="flex items-center justify-between mb-2 md:mb-4">
                    <span className="text-xs font-semibold text-indigo-700 bg-indigo-100/90 px-2 md:px-3 py-1 rounded-full">
                      Minuman
                    </span>
                  ...
                  <h3 className="font-bold text-slate-800 mb-2 md:mb-4 text-sm md:text-xl group-hover:text-indigo-600 transition-colors line-clamp-2">
                    {recipe.name}
                  </h3>

                  <div className="flex items-center justify-between text-xs md:text-sm text-slate-600">
                    <div className="flex items-center space-x-1 md:space-x-2 bg-white/70 px-2 md:px-3 py-1 rounded-full">
